              ...
              <div class="col-lg-6 col-md-12">
                  <div class="card">
                      <div class="card-header">
                          <h5 class="title">Conselheiro Fiscal</h5>
                      </div>
                              ...
                              <div class="card card-user">
                                  <div class="card-body">
                                      ...
                                      <div class="author">
                                          ...
                                          <a href="#">
                                              <img class="avatar" src="{{ asset('black') }}/img/filipe.jpeg" onerror="this.src='{{ asset('black') }}/img/default-avatar.png'" alt="">
                                              <h5 class="title">Filipe Carvalho</h5>
                                          </a>
